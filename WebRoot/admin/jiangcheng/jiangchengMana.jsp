...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<c:forEach items="${requestScope.jiangchengList}" var="jiangcheng" varStatus="ss">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					<td bgcolor="#FFFFFF" align="center">
						${ss.index+1}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${jiangcheng.xuesheng.xingming}
					</td>
					<td bgcolor="#FFFFFF" align="center">
						${jiangcheng.shijian}
					</td>
			...
			<table width='98%'  border='0'style="margin-top:8px;margin-left: 10px;">
			  <tr>
			    <td>
			      <input type="button" value="添加奖惩信息" style="width: 120px;" onclick="jiangchengAdd()" />
			    </td>
			  </tr>
		    </table>
	</body>
